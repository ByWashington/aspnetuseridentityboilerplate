...
namespace AspNet.UserIdentity.Boilerplate.Core.Services
{
	public class AuthManager : IAuthManager
	{
		...
		{
			await _userManager.RemoveAuthenticationTokenAsync(_user, "MyApplicationName", "RefreshToken");
			var newRefreshToken = await _userManager.GenerateUserTokenAsync(_user, "MyApplicationName", "RefreshToken");
			await _userManager.SetAuthenticationTokenAsync(_user, "MyApplicationName", "RefreshToken", newRefreshToken);
		...
		public async Task<TokenRequest> VerifyRefreshToken(TokenRequest request)
		{
			...
			var isValid = await _userManager.VerifyUserTokenAsync(_user, "MyApplicationName", "RefreshToken", request.RefreshToken);

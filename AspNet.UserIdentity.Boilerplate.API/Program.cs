...
using AspNet.UserIdentity.Boilerplate.Core.Extensions;
using AspNet.UserIdentity.Boilerplate.Core.IRepository;
using AspNet.UserIdentity.Boilerplate.Core.Repository;
using AspNet.UserIdentity.Boilerplate.Core.Services;
